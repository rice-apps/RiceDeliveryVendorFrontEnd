...
export interface OrderExampleTabProps extends NavigationScreenProps<{}> {}

// this is just some boilerplate code borrowed from the internet, but the important thing to note is that we
// must export the class OrderTab in order to be able to import it into our navigator

// we must have the custom interface as part of React.Component in order to navigate back in the stack
export class OrderTab extends React.Component<OrderExampleTabProps, {}>{
    ...
    return (
      <View style={styles.container}>
        <Header
            ...
            />
        <Text style={styles.text}>I'm the OrderTab</Text>
      </View>
      )
  }
}
