...
@inject("rootStore")
@observer
class LoginScreen extends React.Component<LoginScreenProps, { modalVisible: boolean, rootStore: RootStore }> {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
    ...
    loginHandler = async () => {
        ...
        console.log(this.state.rootStore.vendorStore.hasAccount);
